...
// (Components can run much longer than Guides) and a fixed max-height would
// either clip long content or leave a long empty gap after short content.
//
...
// `inert` as a valid attribute — it keeps a closed section's controls out
// of both the tab order and the accessibility tree, which aria-hidden
// alone does not do for focusability.
