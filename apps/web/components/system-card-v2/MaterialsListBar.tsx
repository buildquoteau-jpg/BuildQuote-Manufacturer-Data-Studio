...
// out of the Stockists accordion tab so it's never buried behind a
// collapsed section. Rendered directly under the accordion bars, not
// inside any of them — Stockists itself holds only the local stockist
// list. "Add to list" wires to the caller's own list (Data Studio's local,
// in-memory ShoppingListProvider used by SystemCardPreviewWrapper.tsx),
// never a BuildQuote API — this is a read-only preview context.
