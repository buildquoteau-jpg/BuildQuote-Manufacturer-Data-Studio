// Guides and Resources screen. Split back out from Attributes and
// Information after Melia found the combined page needed too much
// scrolling to reach the resources — a real usability problem, not a
// stylistic one. Its own screen means the guides are one bar-tap away
// instead of buried at the bottom of a long spec sheet.
//
// Real centred buttons (meta line + bold label + arrow), not a row list
// with a left icon — Melia asked for this to read as a button, matching
// the old card's "View Evalast / Website ↗" convention. Resource type is
// derived from the real URL (file extension / which field it came from) —
// not invented. Apex PLUS's real "HULK Fasteners Colour guide" and
// "Decking calculator" links map directly onto the brief's "Colour Guide"
// and "Calculator" categories.
