...
// and Stockists — both need the same rows built from the current Choose/
// Components selection.

import type { SystemCardSystem, ShoppingListItem } from '@/components/system-card-renderer/types'
