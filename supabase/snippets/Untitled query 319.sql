...
-- 1. Polymorphic records tied to other manufacturers' staged entities
...
-- 2. Staged system children (other manufacturers)
...
-- 3. Document pipeline (other manufacturers)
DELETE FROM parser_field_evidence
...
-- 4. Staged entities (other manufacturers)
...
-- 5. Publish batches (other manufacturers)
DELETE FROM publish_batch_items
WHERE publish_batch_id IN (
  SELECT id FROM publish_batches WHERE manufacturer_id != '33964b01-8bdd-4385-b7ed-81936d805b56'
);
DELETE FROM publish_batches    WHERE manufacturer_id != '33964b01-8bdd-4385-b7ed-81936d805b56';

-- 6. Users and invites (other manufacturers)
...
-- 7. All other manufacturer records
...
-- SELECT count(*) FROM staged_systems WHERE manufacturer_id = '33964b01-8bdd-4385-b7ed-81936d805b56';
